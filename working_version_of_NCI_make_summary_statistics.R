...
#--------------------------------------------------------------------------------------------
# CONFLUENCE SUMMARY STATISTICS - NCI
...
#--------------------------------------------------------------------------------------------
# CONFLUENCE MISSINGNESS STATISTICS - NCI
...
#--------------------------------------------------------------------------------------------
# SAVE CONFLUENCE NCI SUMMARY AND MISSINGNESS STATISTICS DIRECTLY TO BOX USING BOXR
...
old_df_summ_stat = box_read(691143057533) # old summstat file, DO NOT CHANGE
...
#[9a] Upload the combined file to box using the box file ID of the file to be replaced
box_ul(109394465112, file="NCI_Summary_Statistics.csv", pb = options()$boxr.progress,description = NULL) # UPLOAD AS NEW NCI_Summary_statistics.csv - DON'T CHANGE
